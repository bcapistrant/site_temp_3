---
title: 'Post-Academia, Part 3: Learnings from My Job Search'
author: Ben Capistrant
date: '2020-12-31'
slug: post-academia-part-3
categories: []
tags:
  - Career
  - Data Science
  ...
  - Academia
subtitle: ''
summary: 'Third of three parts on my move from faculty to industry, focused on some of the practical things I learned'
authors: []
lastmod: '2020-12-31T14:37:42-05:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
The [Build a Career in Data Science book](https://www.google.com/search?q=data+science+book+emily+robinson&oq=data+science+book+emily+robin&aqs=chrome.1.69i57j33i22i29i30l2.14020j1j7&sourceid=chrome&ie=UTF-8) from [Emily Robinson](https://twitter.com/robinson_es) and [Jacqueline Nolis](https://twitter.com/skyetetra). 
...
[Ayodele Odubele](https://twitter.com/DataSciBae) also has a book that looks extremely promising: ["Getting Started in Data Science"](https://gumroad.com/l/getting-started-in-data-science) I haven't had the chance to read it yet, but I have really enjoyed her perspective on data science as a field and career on Twitter and can only imagine the book is as good if not even better.
...
In previous searches, I had paid for some of the alt-ac consulting from [The Professor Is In](https://theprofessorisin.com/), which focuses on advice for people with PhDs. I drew from those materials and advice again in this search. I’d recommend them again, no question. They had dedicated folks for non-academic careers and did resume writing/advising, cover letters, and LinkedIn

This time, I used services from a group I’d seen on social media called [Work It Daily](https://www.workitdaily.com/), and they were _great_. They had stand-alone features -- like, pre-recorded videos about interviewing, or guides for people making career changes -- as well as the capacity to interact and get direct feedback on any/all materials and an online network to connect with peers. In particular, their expertise in HR was really insightful for specifics about resume formatting for larger companies’ applicant tracking systems and how to maximize keywords for people to find me on LinkedIn. 

Again, they’re on social media (especially, increasingly, [TikTok](https://www.tiktok.com/@workitdaily)), as are [many other HR experts](https://www.tiktok.com/@thehrvault) who give great advice and even resume review for free.

```{r fig.align="center",  out.width = "70%", echo=FALSE, fig.cap="One of my favorite items from a previous office's 'free shelf'. I did not use it during my search."}
knitr::include_graphics("ResumeBook.jpg")
```


# Do coursework or tutorials to learn new skills, intentionally and sparingly

I did spend time and money on Coursera courses, LinkedIn Learning, and even some workshops and conferences. (A few years ago, I would have used DataCamp, but I would strongly encourage you not to support them -- just click on the date in the twitter text below to go to the tweet). 

```{r echo=FALSE}
blogdown::shortcode('tweet', '1337070088126681095')
```
...
Look for Slack channels (e.g., [OutInTech](https://outintech.com/)), Twitter communities (e.g., [BlackInData](https://twitter.com/blkindata?lang=en)), LinkedIn groups, MeetUps (e.g., [RLadies](https://rladies.org/)) and other virtual networks where you might get intros to jobs or resume advice. 

Better yet, use these conversations and communities to find referrals so that you get to the top of the pile when the HR/Talent/People teams are searching submissions. (I had _no_ idea about referrals, b/c they don't exist in academia. But trust that they are mutually beneficial, not just someone doing you a favor).
...
If you do have a PhD and are trying to make this move, connect with folks who have either made a very similar move or have networks / communities of and resources for folks who have. Two particular favs are [Jennifer Polk](https://twitter.com/FromPhDtoLife) and [Chris Cornthwaite](https://twitter.com/cjcornthwaite) whose content includes more relevant advice for folks in other social sciences and in the humanities.

Use their communities to see how much PhD folx are thriving out of academia (just click on the date in the tweet to go to the tweet/thread):

```{r echo=FALSE}
blogdown::shortcode('tweet', '1340076096470048769')
```


# Being active on social media to learn from others

Just in the last few weeks, I've seen **_excellent_** threads/posts from others on this:

From [Dr. Brianna McHorse](https://twitter.com/fossilosophy) whose advice about moving into data science resonated a lot with me.

```{r echo=FALSE}
blogdown::shortcode('tweet', '1342871356254334977')
```

From [Dr. Emily Kubicek](https://twitter.com/steministemily) whose thread about her path was a delight to read, mimicked some of my own, and whose advice is great.

```{r echo=FALSE}
blogdown::shortcode('tweet', '1336022783403290624')
```


From [Dr. Ali Lawson](https://twitter.com/aflawson), who has superb advice about the process of interviewing and being on the job market.

```{r echo=FALSE}
blogdown::shortcode('tweet', '1344467639415037954')
```
